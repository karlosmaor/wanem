...
api.post('/user/celu', UserCtrl.getUserByCel)
...
api.post('/cierre/caja', ComandaCtrl.CierreCaja)
api.post('/cierrede/caja', ComandaCtrl.CierreCaja2)
api.post('/comandas/cargar/base', ComandaCtrl.CargarBase)
api.post('/comandas/actuales', ComandaCtrl.getComandasActuales)
api.post('/comandas/actuales/dia', ComandaCtrl.getComandasActuales2)
api.post('/comanda', ComandaCtrl.saveComanda)
api.post('/comanda/buscar/fecha', ComandaCtrl.searchFecha)
